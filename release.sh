...
gh release create \
    ...
    --notes "TwitchEmotes Hardcore $version - added bongTime, jointTime, Lamonting, Nerd, Wankge, peepoFine, FeelsWeakMan" \
...
metadata=$(cat <<EOF
{
    "changelog": "$version added bongTime, jointTime, Lamonting, Nerd, Wankge, peepoFine, FeelsWeakMan",
