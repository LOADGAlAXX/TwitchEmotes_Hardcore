...
gh release create \
    ...
    --notes "TwitchEmotes Hardcore $version - added buhOverShakeyFlipExplode, ShouldIDoIt, ohno | Increased Size of wideBoink " \
...
metadata=$(cat <<EOF
{
    "changelog": "$version - added buhOverShakeyFlipExplode, ShouldIDoIt, ohno | Increased Size of wideBoink",
